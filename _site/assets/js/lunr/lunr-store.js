var store = [{
        ...
        "tags": [],
        "url": "https://localhost:4000/Mozzi/workshops/music-hack-day-barcelona-workshop-announcement/",
        "teaser":"https://localhost:4000/Mozzi"},{
        ...
        "tags": [],
        "url": "https://localhost:4000/Mozzi/conference/talk/upcoming-mozzi-talk-at-icmc2013-in-perth/",
        "teaser":"https://localhost:4000/Mozzi"},{
        "title": "Simpler adc with mozziAnalogRead",
        "excerpt":"Version 2013-08-25 evolves the adc developments of the previous release, byreplacing the various ways of reading analog inputs (adcGetResult(),adcReadAllChannels(), etc.) with mozziAnalogRead(). Use it the same asanalogRead(). It doesn’t need any special setup. Audio input still uses getAudioInput(), not mozziAnalogRead(). Here’s the Mozzi/extras/NEWS.txt entry of the changes in this release: &hellip;","categories": ["updates","adc"],
        "tags": [],
        "url": "https://localhost:4000/Mozzi/updates/adc/simpler-adc-with-mozzianalogread/",
        "teaser":"https://localhost:4000/Mozzi"},{
        "title": "Mozzi Marketplace on Sharetribe",
        "excerpt":"We (well, me and my brother Steph) are experimenting with the idea of a Mozzi marketplace where people can sell or swap things made with Mozzi. The first test is with Sharetribe. We hope a marketplace will help ferment the Mozzi culture, but also there’s a remote thought of generating &hellip;","categories": ["marketplace","kits"],
        "tags": [],
        "url": "https://localhost:4000/Mozzi/marketplace/kits/mozzi-marketplace-on-sharetribe/",
        "teaser":"https://localhost:4000/Mozzi"},{
        "title": "Making Things Purr, Growl and Sing - Mozzi workshop in Melbourne",
        "excerpt":"We will be running a Mozzi synth workshop in Melbourne on Thursday 20th March, 14:00-20:00. Participants will get a grip on Mozzi, and have a chance to work on their own projects, with help from me (Tim, the creator of Mozzi) and my brother Stephen Barrass (a media arts researcher &hellip;","categories": ["workshops"],
        "tags": [],
        "url": "https://localhost:4000/Mozzi/workshops/making-things-purr/",
        "teaser":"https://localhost:4000/Mozzi"},{
        "title": "New STANDARD_PLUS audio mode removes 16kHz whine",
        "excerpt":"Took a long time coming… version 2014-03-13-14:09 MozziGuts.cpp/h,mozzi_config.h - Added STANDARD_PLUS audio mode. This is now the default audio mode. Just like STANDARD, but with 32768Hz PWM rate, so the whine which some people hear in STANDARD mode is now out of hearing range. A notch filter is not required &hellip;","categories": ["updates","audio modes"],
        "tags": [],
        "url": "https://localhost:4000/Mozzi/updates/audio%20modes/update-to-version-2014-03-13-14-09/",
        "teaser":"https://localhost:4000/Mozzi"},{
        ...
        "tags": [],
        "url": "https://localhost:4000/Mozzi/audio/updates/standard-plus-performance-improves/",
        "teaser":"https://localhost:4000/Mozzi"},{
        "title": "Teensy 3.0-3.1 port progress",
        "excerpt":"This is an update regarding work in progress on the port to Teensy 3.0 and 3.1,to let donors to the project know where the work is up to. It’s taking a bit longer than anticipated,but I want to assure people who are waiting that the work is well underway. However, &hellip;","categories": ["ports"],
        "tags": [],
        "url": "https://localhost:4000/Mozzi/ports/teensy-3-dot-0-3-dot-1-port-progress/",
        "teaser":"https://localhost:4000/Mozzi"},{
        "title": "Teensy 3.0/3.1 test release",
        "excerpt":"This release is a test of the recent work on the Mozzi Teensy 3 port in response to the donation campaign reaching the grand goal of $1000.Thankyou to all the dozen or so donors, especially my brother and sister, who donated more than half! It should run as usual on &hellip;","categories": ["ports","Teensy","releases"],
        "tags": [],
        "url": "https://localhost:4000/Mozzi/ports/teensy/releases/teensy-3-dot-0-slash-3-dot-1-test-release-version-2014-08-09-14-15/",
        "teaser":"https://localhost:4000/Mozzi"},{
        ...
        "tags": [],
        "url": "https://localhost:4000/Mozzi/yes/",
        "teaser":"https://localhost:4000/Mozzi"},{
        ...
        "tags": [],
        "url": "https://localhost:4000/Mozzi/use-arduino-1-dot-0-5/",
        "teaser":"https://localhost:4000/Mozzi"},{
        "title": "Release v1.0.2",
        "excerpt":"New version released, named Aedes australis, v1.0.2. Updated 2015-05-11-20:23 First (slightly edited) versioned release using GitHub release process. Warning: This release and all previous versions of Mozzi run slow when using Arduino IDE versions greater than 1.0.5, at least on OSX, causing glitches on many of the included examples. Simple &hellip;","categories": [],
        "tags": [],
        "url": "https://localhost:4000/Mozzi/release-1-dot-0-2/",
        "teaser":"https://localhost:4000/Mozzi"},{
        "title": "Howto for Arduino 1.6.11",
        "excerpt":"Now Mozzi can work at full speed on the latest Arduino IDE. It works, but now Mozzi needs an update to install smoothly in recent IDE’s. Coming soon, with some other fixes. The problem for Mozzi on Arduino IDE’s after 1.0.5 used to be that sketches were compiled for small &hellip;","categories": ["fixes","updates"],
        "tags": [],
        "url": "https://localhost:4000/Mozzi/fixes/updates/howto-for-arduino-1-dot-6-11/",
        "teaser":"https://localhost:4000/Mozzi"},{
        "title": "Update 1.0.3rc1 available",
        "excerpt":"release v1.0.3 Mostly bug fixes and maintainance, with update to suit Arduino 1.5+. Though tests show the 1.0.5 IDE still produces faster code than any speed optimisation levels compiled with the newer versions. added library.properties for Arduino 1.5+ MozziGuts.cpp and .h, and mozzi_config.h: added STEREO_HACK config option, set it to &hellip;","categories": [],
        "tags": [],
        "url": "https://localhost:4000/Mozzi/update-1-dot-0-3rc1-available/",
        "teaser":"https://localhost:4000/Mozzi"},{
        "title": "Tweak for faster code",
        "excerpt":"If you need your synth to run fast, Arduino versions above 1.5 can be tweaked to optimise compiled code for speed instead of small size. Find Arduino’s platform.txt (on OSX you can find it by searching in Users/your_name/Library/Arduino15). Search and replace -Os with -O2. Save. It’s explained more thoroughly (for &hellip;","categories": [],
        "tags": [],
        "url": "https://localhost:4000/Mozzi/tweak-for-faster-code/",
        "teaser":"https://localhost:4000/Mozzi"},{
        ...
        "tags": [],
        "url": "https://localhost:4000/Mozzi/releases,/bugfix/v1-dot-0-3rc2-teensy-bugfix/",
        "teaser":"https://localhost:4000/Mozzi"},{
        ...
        "tags": [],
        "url": "https://localhost:4000/Mozzi/releases,/bugfix/v1-dot-0-3rc4-fixes-compile/",
        "teaser":"https://localhost:4000/Mozzi"},{
