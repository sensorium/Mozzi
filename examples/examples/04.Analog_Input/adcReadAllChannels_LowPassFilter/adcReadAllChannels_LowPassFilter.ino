...
void updateControl(){
  ...
  unsigned char modulation_width = (unsigned char) (adcGetResult(MOD_WIDTH_ANALOG_IN)>>4); // 0 to 63
  ...
  adcReadAllChannels(); // triggers a series of interrupts to read each channel in the background
}
