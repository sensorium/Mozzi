...
#define Q1n14_float2fix(a) ((Q1n14)((a)*16384.f))		/**<Convert float to fix. @param a is a float*/
#define Q1n14_fix2float(a) ((float)(a)/16384.f)			/**<Convert fix to float. @param a is an int*/
...
#define Q8n24_fix2float(a) ((float)(a)/16777216.f))		/**<Convert fix to float. @param a is a Q8n24 unsigned long*/

#define Q23n8_float2fix(a) ((Q23n8)((a)*256.f))		/**<Convert float to Q23n8 fix. @param a is a float*/
#define Q23n8_fix2float(a) ((float)(a*0.00390625))		/**<Convert fix to float. @param a is a Q23n8 signed long*/
...
#define Q24n8_float2fix(a) ((Q24n8)((a)*256.f))		/**<Convert float to Q24n8 fix. @param a is a float*/
#define Q24n8_fix2float(a) ((float)(a*0.00390625))		/**<Convert fix to float. @param a is a Q24n8 unsigned long*/
...
#define Q15n16_float2fix(a) ((Q15n16)((a)*65536.f))		/**<Convert float to Q15n16 fix. @param a is a float*/
#define Q15n16_fix2float(a) ((float)(a)*0.000015258789063)	/**<Convert fix to float. @param a is a Q15n16 signed long*/
