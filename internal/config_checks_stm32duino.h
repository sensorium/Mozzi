...
#elif defined(ADC_RESOLUTION_12B)
...
#define MOZZI__INTERNAL_ANALOG_READ_RESOLUTION 8
#elif defined(ADC_RESOLUTION_6B)
#define MOZZI__INTERNAL_ANALOG_READ_RESOLUTION 6
#else
#error This should not happen. HAL not included?
#endif
